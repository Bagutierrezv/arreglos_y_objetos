import { propiedadesEnVenta, propiedadesEnAlquiler } from "./data/propiedades.js"

console.log(propiedadesEnVenta, propiedadesEnAlquiler)

const propiedadesParaMostrar = (propiedades, contenedoresId) => {
    const container = document.getElementById(contenedoresId)
    container.className = 'row'
    const propiedadesInicio = propiedades.slice(0, 3)

    for (const propiedad of propiedadesInicio) {
...
propiedadesParaMostrar(propiedadesEnVenta, 'ventasContainer')
